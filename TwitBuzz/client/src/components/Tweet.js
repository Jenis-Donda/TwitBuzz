                ...
                {(_close) => (
                  <ul className="delete-popup" style={{ listStyle: "none" }}>
                    ...
                    {props.bookmark ? (
                      <li>
                        <form
                          onSubmit={bookmarkTweet}
                          action={`http://localhost:5000/removebookmark/${props.user}/${tweetid}`}
                          style={{ marginBottom: "0", color: "#ba1919" }}
                        >
                          <button className="delete-btn">
                            <BsBookmarkXFill /> Remove
                          </button>
                        </form>
                      </li>
                    ) : (
                      <li>
                        <form
                          onSubmit={bookmarkTweet}
                          action={`http://localhost:5000/bookmark/${props.user}/${tweetid}`}
                    ...
                    {isUserActive && (
                      <li>
                        <form
                          ...
                          style={{ marginBottom: "0", color: "#e90505" }}
                        >
                          <button className="delete-btn">
